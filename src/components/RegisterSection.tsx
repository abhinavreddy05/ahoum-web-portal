...
const RegisterSection = () => {
  ...
  return <div className="w-full py-20 md:py-24 px-4 md:px-6 lg:px-8 bg-background mt-8 md:mt-12 lg:mt-16 lg:py-[20px]">
      <div className="max-w-4xl mx-auto text-center">
        ...
        <form onSubmit={handleRegister} className="mb-8 md:mb-10">
          <div className="flex flex-col sm:flex-row gap-4 md:gap-6 max-w-lg mx-auto">
            <input type="email" value={email} onChange={e => setEmail(e.target.value)} placeholder="Enter your email" required className="flex-1 px-6 md:px-8 py-3 md:py-4 border-2 border-foreground bg-transparent font-montserrat text-sm md:text-base text-foreground placeholder:text-foreground/50 focus:outline-none focus:ring-0 rounded-2xl transition-all duration-300 focus:border-foreground/80" />
            <button type="submit" className="font-montserrat border-2 border-foreground text-foreground px-8 md:px-10 py-3 md:py-4 text-sm md:text-base rounded-[20px] hover:bg-foreground hover:text-background transition-all duration-300 whitespace-nowrap font-medium">
              Register
            </button>
          </div>
        </form>
