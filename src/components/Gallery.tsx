      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 h-[400px] md:h-[500px] lg:h-[600px] overflow-hidden">
          <div className="col-span-2 row-span-2 overflow-hidden rounded-lg">
            <img src={images[0]} alt="Gallery image 1" className="w-full h-full object-cover shadow-lg transition-transform duration-300 hover:scale-105" />
          </div>
          <div className="col-span-2 md:col-span-1 overflow-hidden rounded-lg">
            <img src={images[1]} alt="Gallery image 2" className="w-full h-full object-cover shadow-lg transition-transform duration-300 hover:scale-105" />
          </div>
          <div className="col-span-2 md:col-span-1 overflow-hidden rounded-lg">
            <img src={images[2]} alt="Gallery image 3" className="w-full h-full object-cover shadow-lg transition-transform duration-300 hover:scale-105" />
          </div>
          <div className="col-span-2 overflow-hidden rounded-lg">
            <img src={images[3]} alt="Gallery image 4" className="w-full h-full object-cover shadow-lg transition-transform duration-300 hover:scale-105" />
          </div>
        </div>
      </div>
    </div>;
